...
released in early 1997. Doing so, the developer can achieve two main scopes: 
reusing his native code under a Java environment, and optimising the execution
...
case of the \textit{JIT-ed} code, where the bytecode is compiled to run natively
at a certain time (commonly at launch time, but can happen at install time, or 
method invoke time).\\
