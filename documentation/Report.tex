...
particularly for its performance-oriented needs. That being said - except for
the peculiar case of the \textit{JIT-ed} code - who's responsible for connecting
the high-level Java application layer to the native world, and the other way
around? Yes, this filling is JNI, which was initially released in early 1997.
...
\begin{figurehere}
 \centering
 \includegraphics[width=8cm]{./figures/jni-flow.png}
 \caption{JNI flow}
 \label{fig:jni-flow}
\end{figurehere}
